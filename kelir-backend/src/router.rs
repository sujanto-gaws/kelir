...
#[openapi(
    paths(
        ...
        identity::handlers::list_delegations,
        identity::handlers::create_delegation,
        identity::handlers::end_delegation,
        ...
        rad::handlers::get_renderable_list,
        rad::handlers::list_rows,
        rad::handlers::list_actions,
        rad::handlers::list_menus,
        rad::handlers::get_menu,
        rad::handlers::create_menu,
        rad::handlers::update_menu,
        rad::handlers::delete_menu,
        ...
        master_data::handlers::list_party_change_requests,
        master_data::handlers::list_facility_change_requests,
        comment::handlers::add_comment,
        comment::handlers::list_comments,
        comment::handlers::edit_comment,
        comment::handlers::delete_comment,
        ...
        workflow::handlers::delegate_task,
    ...
    components(schemas(
        ...
        master_data::domain::ChangeAttempt,
        ...
        identity::delegation::DelegationScope,
        identity::delegation::CreateDelegationRequest,
        ...
        workflow::domain::DelegateRequest,
...
fn api_v1_router(state: AppState) -> Router<AppState> {
    ...
    Router::new()
        ...
        // **Composed here rather than inside any of the three modules**, so the
        // document module does not import the two that hang off it and neither
        // of those has to know its own prefix. The parameter is `{id}` and not
        // `{document_id}` because the router they nest into already binds `{id}`
        // at that position, and axum refuses two names for one segment.
        .nest(
            "/documents",
