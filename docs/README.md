...
| Planning | Complete — sprint plan and product backlog cover all 164 FRs. Scope decisions **D-1…D-91** are recorded in [Product Backlog](../projects/planning/02.%20Product%20Backlog.md) §6; none is open since 2026-09-18, when the product owner answered **D-73**, **D-86**, **D-90** and **D-91**, and **D-7** is superseded by **D-18**. Phase 9 is Sprints 20–22 by **D-90**, with `v0.9.0` at Sprint 22 and `v1.0.0` after hardening at Sprint 24. Sprints 0–20 are detailed in [Sprint Plan](../projects/planning/01.%20Sprint%20Plan.md) §5, and later sprints are detailed at each phase boundary |
