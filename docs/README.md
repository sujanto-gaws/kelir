...
| Implementation | Phase 1 released as `v0.1.0` (cut 2026-08-12), **not yet verified on staging** — that deploy is the one blocking step. Backend: config, SQLx pool and `0001_core.sql`, health and version endpoints, response envelope and `AppError`, pagination, OpenAPI, CORS. Frontend: app shell, envelope-aware API client, login page, Tailwind v4 and shadcn-vue baseline. See [Release v0.1.0](../projects/releases/01.%20Release%20v0.1.0.md) |
