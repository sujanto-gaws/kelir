...
| Planning | Complete — sprint plan and product backlog cover all 164 FRs. Scope decisions **D-1…D-95** are recorded in [Product Backlog](../projects/planning/02.%20Product%20Backlog.md) §6, and **none is open** since 2026-09-26. **D-7** is superseded by **D-18**. The last, **D-95**, settled that [#426](https://github.com/sujanto-gaws/kelir/issues/426)'s workflow builder edits a state list, and draws the definition as a read-only graph with no stored layout. Phase 9 is Sprints 20–22 by **D-90**, with `v0.9.0` at Sprint 22 and `v1.0.0` after hardening at Sprint 24. `v0.9.0` is the integration core, not plugins, by **D-94**. Sprints 0–21 are detailed in [Sprint Plan](../projects/planning/01.%20Sprint%20Plan.md) §5, and later sprints are detailed at each phase boundary |
