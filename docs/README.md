...
| Planning | Complete — sprint plan and product backlog cover all 164 FRs. Scope decisions **D-1…D-88** are recorded in [Product Backlog](../projects/planning/02.%20Product%20Backlog.md) §6; two are open, **D-73** and **D-86**, and **D-7** is superseded by **D-18**. Sprints 0–19 are detailed in [Sprint Plan](../projects/planning/01.%20Sprint%20Plan.md) §5, and later sprints are detailed at each phase boundary |
